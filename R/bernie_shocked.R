...
#' @export
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
geom_bernie_shocked <- function(mapping     = NULL,
                        data        = NULL,
                        stat        = "identity",
                        position    = "identity",
                        ...,
...
#' @export
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
GeomBernieShocked <- ggplot2::ggproto(
  "GeomBernieShocked", ggplot2::Geom,
  required_aes = c("x", "y"),
  ...
  default_aes = ggplot2::aes(
    ...
    alpha  = NA,
    stroke = 0.5,
    image_filename  = system.file("bernie_shocked.png", package = "ggBernie", mustWork = TRUE),
    scale = 5
  ),
