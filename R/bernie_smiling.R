...
#' @export
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
geom_bernie_smiling <- function(mapping     = NULL,
                              data        = NULL,
                              stat        = "identity",
                              position    = "identity",
                              ...,
...
#' @export
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
GeomBernieSmiling <- ggplot2::ggproto(
  "GeomBernieSmiling", ggplot2::Geom,
  required_aes = c("x", "y"),
  ...
  default_aes = ggplot2::aes(
    ...
    alpha  = NA,
    stroke = 0.5,
    image_filename  = system.file("bernie_smiling.png", package = "ggBernie", mustWork = TRUE),
    scale = 5
  ),
